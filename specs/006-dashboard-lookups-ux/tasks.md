...
**Input**: Design documents from `/specs/006-dashboard-lookups-ux/`
...
- [x] T001 Confirm feature docs present under `specs/006-dashboard-lookups-ux/` (plan, research, data-model, contracts, quickstart)
...
- [x] T033 Manual pass against `specs/006-dashboard-lookups-ux/quickstart.md`
