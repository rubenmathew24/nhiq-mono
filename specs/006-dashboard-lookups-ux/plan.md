...
**Branch**: `006-dashboard-lookups-ux` | **Date**: 2026-07-21 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `/specs/006-dashboard-lookups-ux/spec.md`
...
```text
specs/006-dashboard-lookups-ux/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
