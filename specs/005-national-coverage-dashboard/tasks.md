...
**Input**: Design documents from `/specs/005-national-coverage-dashboard/`

**Prerequisites**: plan.md, spec.md, research.md, data-model.md, contracts/

## Phase 1: Setup

- [x] T001 Verify `specs/005-national-coverage-dashboard/` artifacts and `.specify/feature.json` point here
...
- [x] T011b [US2] Overall ↔ By state parity: EPA by-state uses monitor counties only (`0/0` if none); sum(by-state)==national for every job; By state Overall mean skips `total_count=0`; update 005 spec/data-model/contract/research
