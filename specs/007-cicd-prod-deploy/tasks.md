...
**Input**: Design documents from `/specs/007-cicd-prod-deploy/`
...
- [x] T001 Confirm feature docs under `specs/007-cicd-prod-deploy/` (plan.md, research.md, data-model.md, contracts/cicd-deploy.md, quickstart.md)
...
- [x] T006 Document local runner invocation in `specs/007-cicd-prod-deploy/quickstart.md` if commands drift during implement (keep in sync)
...
- [x] T008 [P] [US1] Add workflow comment/checklist in `specs/007-cicd-prod-deploy/quickstart.md` §4–5 describing how to validate detect skips / migrate-before-images (manual Actions validation after merge)
...
- [x] T028 Run through `specs/007-cicd-prod-deploy/quickstart.md` validation checklist and fix any drift in scripts/workflows/docs
