...
const mockReport = {
  ...
  longitude: -97.7431,
  overall_score: 82,
  healthcare: { score: 87, label: "Healthcare", summary: "", factors: [], sub_scores: [] },
  safety: { score: 74, label: "Safety", summary: "", factors: [], sub_scores: [] },
  environment: { score: 74, label: "Environment", summary: "", factors: [], sub_scores: [] },
  education: { score: 91, label: "Schools", summary: "", factors: [], sub_scores: [] },
  economic: { score: 68, label: "Economy", summary: "", factors: [], sub_scores: [] },
