...
function DiscoverMapInner() {
  ...
  if (!bbox) {
    return (
      <div className="min-h-screen bg-background text-foreground font-sans">
        <Header />
        <main className="max-w-3xl mx-auto px-6 pt-28 pb-20 space-y-4">
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      <Header />
      <main className="max-w-6xl mx-auto px-6 pt-28 pb-16 space-y-6">
        ...
        {loading && (
          <p className="text-sm text-muted-foreground">Loading neighborhood overlay…</p>
        )}
        ...
        <div className="relative">
          <DiscoverMap bbox={bbox} placeName={place} tracts={tracts} />
...
export default function DiscoverMapPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-background pt-28 px-6 text-muted-foreground">
          Loading Discover map…
        </div>
      }
    >
      <DiscoverMapInner />
